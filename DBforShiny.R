...
# 
# if (length(args)<10) {
#   stop("Ten arguments (Site, Protocol, Sample, TSI_Br, TSI_Lv, TSI_Pl, BP_sim, BW, FC, Prop) must be supplied (e.g. Lab008, NGS004, NIST05, 10, 10, 10, 0.075, 2, 1.5, 0.95)\n", call.=FALSE)
# }
# 
# Site     <- args[1]
# Protocol <- args[2]
...
#######################################
ShinyDB6P <- function (Site, Protocol, Sample, TSI_Br, TSI_Lv, TSI_Pl, BP_sim, BW, FC, Prop) {
